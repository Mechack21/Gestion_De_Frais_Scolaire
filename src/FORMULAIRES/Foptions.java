 ...
 * @author MECHACK
 */
public class Foptions extends javax.swing.JFrame {

    Options opt = new Options();
    Sections sct = new Sections();

    /**
     * Creates new form Foptions
     */
    public Foptions() {
        initComponents();
        fillCombo();
    ...
    void Nettoyer() {
        TxtCodeoPT.setText("");
        TxtLibo.setText("");
        CmbSEct.setSelectedItem("");
    }

    final void afficherDonnees() {
        opt.Remplir(jTable1, "select options.codeopt,options.Libelle,sections.libelle\n"
                + "from options inner join sections on options.codesect=sections.codesect");
    }

    void deplacerDonness() {
        int ligne = jTable1.getSelectedRow();
        TxtCodeoPT.setText(jTable1.getValueAt(ligne, 0).toString());
        TxtLibo.setText(jTable1.getValueAt(ligne, 1).toString());
        CmbSEct.setSelectedItem(jTable1.getValueAt(ligne, 2).toString());
    }
    ...
    void rechercheParNomClasse() {
        opt.Remplir(jTable1, "select options.codeopt,options.Libelle,sections.libelle\n"
                + "from options inner join sections on options.codesect=sections.codesect\n"
                + "\n"
                + "where options.Libelle like '%" + texteFldRecherche.getText() + "%'");
    }

    void insertInClasses() {
        if (TxtCodeoPT.getText().equals("") || TxtLibo.getText().equals("") || CmbSEct.getSelectedItem().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            opt.setCdeOption(TxtCodeoPT.getText());
            opt.setLibelle(TxtLibo.getText());
            String id;
            id = sct.IDsection(CmbSEct.getSelectedItem().toString());
            opt.setCdeSect(id);
            opt.Ajouter();
            afficherDonnees();
            Nettoyer();
    ...
    private void initComponents() {
        ...
        TxtCodeoPT = new javax.swing.JTextField();
        TxtLibo = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        CmbSEct = new javax.swing.JComboBox();
        ...
        jLabel1.setText("ENREGISTREMENT DES OPTIONS");
        ...
        jLabel2.setText("CODE OPTION");

        jLabel3.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel3.setText("LIBELLE");

        TxtCodeoPT.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        TxtLibo.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        jLabel5.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel5.setText("SECTION");

        CmbSEct.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(48, 48, 48)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(TxtLibo, javax.swing.GroupLayout.DEFAULT_SIZE, 311, Short.MAX_VALUE)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addComponent(CmbSEct, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, Short.MAX_VALUE))))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(TxtCodeoPT, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(TxtCodeoPT, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(TxtLibo, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(36, 36, 36)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
                    .addComponent(CmbSEct, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        setSize(new java.awt.Dimension(678, 601));
    ...
    private javax.swing.JComboBox CmbSEct;
    private javax.swing.JTextField TxtCodeoPT;
    private javax.swing.JTextField TxtLibo;
