 ...
 * @author MECHACK
 */
public class Fsections extends javax.swing.JFrame {
    Sections sctn=new Sections();
    /**
     * Creates new form Fsections
     */
    public Fsections() {
        initComponents();
        afficherDonnees();
    ...
    void Nettoyer() {
        TxtCodeSection.setText("");
        TxtLibelle.setText("");
    }

    final void afficherDonnees() {
        sctn.Remplir(jTable1, "select * from SECTIONS");
    }

    void deplacerDonness() {
        int ligne = jTable1.getSelectedRow();
        TxtCodeSection.setText(jTable1.getValueAt(ligne, 0).toString());
        TxtLibelle.setText(jTable1.getValueAt(ligne, 1).toString());
    }

    void rechercheParNomClasse() {
        sctn.Remplir(jTable1, "select * from SECTIONS where Libelle like '%"+texteFldRecherche.getText()+"%'");
    }

    void insertInClasses() {
        if (TxtCodeSection.getText().equals("") || TxtLibelle.getText().equals("") ) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            sctn.setCdeSect(TxtCodeSection.getText());
            sctn.setLibelle(TxtLibelle.getText());
            sctn.Ajouter();
            afficherDonnees();
            Nettoyer();
        }
    ...
    void deleteInClasses() {
        ...
        if (rep == JOptionPane.YES_OPTION) {
            if (TxtCodeSection.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Veuillez selectionner une ligne", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
            } else {
                sctn.setCdeSect(TxtCodeSection.getText());
                sctn.Supprimer();
    ...
    private void initComponents() {
        ...
        TxtCodeSection = new javax.swing.JTextField();
        ...
        jLabel1.setText("ENREGISTREMENT DES SECTIONS");
        ...
        jLabel2.setText("CODE SECTION");

        jLabel3.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        jLabel3.setText("LIBELLE");

        TxtCodeSection.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(TxtCodeSection, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(TxtCodeSection, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(35, 35, 35)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
        ...
        setSize(new java.awt.Dimension(687, 601));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fsections.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField TxtCodeSection;
