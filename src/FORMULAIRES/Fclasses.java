 ...
 * @author MECHACK
 */
public class Fclasses extends javax.swing.JFrame {

    Classes cls = new Classes();
    Options opt = new Options();

    /**
     * Creates new form Fclasses
     */
    public Fclasses() {
        initComponents();
        fillCombo();
    ...
    void Nettoyer() {
        TxtCde.setText("");
        TxtLib.setText("");
        CmbOption.setSelectedItem("");
    }

    final void afficherDonnees() {
        cls.Remplir(jTable1, "select CLASSES.CodeClass,CLASSES.Libelle,OPTIONS.libelle\n"
                + "from classes inner join options on classes.codeopt=options.codeopt");
    }

    void deplacerDonness() {
        int ligne = jTable1.getSelectedRow();
        TxtCde.setText(jTable1.getValueAt(ligne, 0).toString());
        TxtLib.setText(jTable1.getValueAt(ligne, 1).toString());
        CmbOption.setSelectedItem(jTable1.getValueAt(ligne, 2).toString());
    }
    ...
    void rechercheParNomClasse() {
        cls.Remplir(jTable1, "select CLASSES.CodeClass,CLASSES.Libelle,OPTIONS.libelle\n"
                + "from classes inner join options on classes.codeopt=options.codeopt\n"
                + "\n"
                + "where CLASSES.Libelle like '%" + texteFldRecherche.getText() + "%'");
    }

    void insertInClasses() {
        if (TxtCde.getText().equals("") || TxtLib.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Veuillez remplir tous les champs", "ATTENTION!!", JOptionPane.ERROR_MESSAGE);
        } else {
            cls.setCdeClasse(TxtCde.getText());
            cls.setLibelle(TxtLib.getText());
            String id;
            id = opt.IDoption(CmbOption.getSelectedItem().toString());
            cls.setCdeOption(id);
            cls.Ajouter();
            afficherDonnees();
            Nettoyer();
    ...
    void EditInClasses() {
        ...
        if (rep == JOptionPane.YES_OPTION) {
            if (TxtCde.getText().equals("") || TxtLib.getText().equals("") || CmbOption.getSelectedItem().equals("")) {
    ...
    private void initComponents() {
        ...
        TxtCde = new javax.swing.JTextField();
        ...
        TxtCde.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        TxtLib.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N

        CmbOption.setEditable(true);
        CmbOption.setFont(new java.awt.Font("Baskerville Old Face", 0, 14)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(CmbOption, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(TxtLib, javax.swing.GroupLayout.Alignment.LEADING)
                        .addComponent(TxtCde, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 168, Short.MAX_VALUE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(TxtCde, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
        ...
        jPanel3.setFont(new java.awt.Font("Tempus Sans ITC", 0, 14)); // NOI18N
        ...
        setSize(new java.awt.Dimension(643, 603));
    ...
    private void BTMODIFIERActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BTMODIFIERActionPerformed
        EditInClasses();        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fclasses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField TxtCde;
